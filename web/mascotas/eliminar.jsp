...
<html>
    <head>
        ...
        <title>Fichas - Eliminar</title>
    </head>
    <body>
        <header>
            <h1>Eliminar Fichas</h1>
        </header>
        <div>
            <%
            ...
            <c:if test="${not empty ficha}">
                <form action="<%=request.getContextPath()%>/AdminFichas" method="POST">
                    ...
                    <table>
                        ...
                        <tr>
                            <td>Fecha Creación</td><td><input type="date" name="fecha_creacion" readonly value="${ficha.getFechaCreacion()}"></td>
                        </tr>
                        <tr>
                            <td>Peso</td><td><input type="text" name="peso" maxlength="6" readonly value="${ficha.getPeso()}"></td>
                        </tr>
                        <tr>
                            <td>Tamaño</td><td><input type="number" name="tamano" maxlength="6" readonly value="${ficha.getTamaño()}"></td>
                        </tr>
                        <tr>
